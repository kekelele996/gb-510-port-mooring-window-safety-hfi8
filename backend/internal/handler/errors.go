...
func handleError(c *gin.Context, err error) {
	...
	case errors.Is(err, service.ErrInvalidTransition), errors.Is(err, service.ErrInvalidInput),
		...
		errors.Is(err, service.ErrWindowVersion), errors.Is(err, service.ErrWindowUnsafe),
		errors.Is(err, service.ErrVersionChanged), errors.Is(err, service.ErrRebindRequired),
		errors.Is(err, service.ErrWindowUnbound):
